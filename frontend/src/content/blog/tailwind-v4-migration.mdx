...
No `dark:` prefix. The CSS variables resolve to the right values based on the active theme. The same markup works for Dracula, Alucard, Nord, Gruvbox, Midnight, and Dawn.
